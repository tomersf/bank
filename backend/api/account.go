...
type updateAccountRequest struct {
	updateAccountRequestID
	updateAccountRequestBalance
}

func (server *Server) updateAccount(ctx *gin.Context) {
	var balanceReq updateAccountRequestBalance
	if err := ctx.ShouldBindJSON(&balanceReq); err != nil {
		ctx.JSON(http.StatusBadRequest, errorResponse(err))
		return
	}
	var idReq updateAccountRequestID
	...
	updateRequest := updateAccountRequest{
		updateAccountRequestID:      idReq,
		updateAccountRequestBalance: balanceReq,
	}
